...
public class UsuarioServicio {
    ...
    public static List<Usuario>listarusuario() {
        ...
        return (List<Usuario>) usuarioRepositorio.listar();
    }

    public Usuario buscarUsuarios(String cedula) throws Exception {
    ...
    public void actualizarusuario(Map datos) {
        ...
        Usuario newPerson = new Usuario( id,nombre, apellido, cedula);
